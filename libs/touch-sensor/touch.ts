...
namespace sensors {
    ...
    export class TouchSensor extends internal.AnalogSensor {
        ...
        //% blockId=touchWaitUntil block="wait until %sensor|%event"
        //% parts="touch"
        //% blockNamespace=sensors
    ...
    //% whenUsed block="touch 1" weight=95 fixedInstance
    export const touchSensor1: TouchSensor = new TouchSensor(1)
    //% whenUsed block="touch 2" weight=95 fixedInstance
    export const touchSensor2: TouchSensor = new TouchSensor(2)
    //% whenUsed block="touch 3" weight=95 fixedInstance
    export const touchSensor3: TouchSensor = new TouchSensor(3)
    //% whenUsed block="touch 4" weight=95 fixedInstance
