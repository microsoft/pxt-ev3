...
namespace brick {
    ...
    //% weight=95 group="Screen" inlineInputMode="inline" blockGap=8
     ...
     */
    //% blockId=screenPrintString block="show string %text|at line %line||and column %column|with style %printStyle"
